...
namespace SSM.Backend.Controllers
{
    ...
    public class SpecialityController : ControllerBase
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<ActionResult<List<SpecialityDTO>>> GetAllAsync(int _start, int _end, string? undefined = "", string? title_like = "")
        {
            try
            {
                ...
                var entities = await _db.GetAllAsync(_start:_start,_end: _end,filter, filterTitle);
